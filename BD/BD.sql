...
CREATE TABLE ALUMNE (
  ...
  KEY CURS_ID (CURS_ID),
  CONSTRAINT ALUMNE_ibfk_1 FOREIGN KEY (CURS_ID) REFERENCES CURS (ID_CURS) ON DELETE SET NULL
);
...
CREATE TABLE ASSIGNATURA (
  ...
  KEY CURS_ID (CURS_ID),
  CONSTRAINT ASSIGNATURA_ibfk_1 FOREIGN KEY (CURS_ID) REFERENCES CURS (ID_CURS) ON DELETE CASCADE
);
...
CREATE TABLE NOTA (
  ...
  CONSTRAINT NOTA_ibfk_1 FOREIGN KEY (ASSIGNATURA_ID) REFERENCES ASSIGNATURA (ID_ASSIGNATURA) ON DELETE CASCADE,
  CONSTRAINT NOTA_ibfk_2 FOREIGN KEY (CURS_ID) REFERENCES CURS (ID_CURS) ON DELETE CASCADE,
  CONSTRAINT NOTA_ibfk_3 FOREIGN KEY (ALUMNE_ID) REFERENCES ALUMNE (ID_ALUMNE) ON DELETE CASCADE
);
